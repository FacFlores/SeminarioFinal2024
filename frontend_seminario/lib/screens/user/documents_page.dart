...
class UserDocumentsPage extends StatefulWidget {
  ...
  @override
  UserDocumentsPageState createState() => UserDocumentsPageState();
}

class UserDocumentsPageState extends State<UserDocumentsPage> {
            ...
            content: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items:
                      consortiums.map<DropdownMenuItem<String>>((consortium) {
                    return DropdownMenuItem<String>(
