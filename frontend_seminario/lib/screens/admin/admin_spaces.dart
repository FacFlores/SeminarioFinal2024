...
class AdminSpacesPage extends StatefulWidget {
  const AdminSpacesPage({Key? key}) : super(key: key);

  @override
  State<AdminSpacesPage> createState() => _AdminSpacesPageState();
}

class _AdminSpacesPageState extends State<AdminSpacesPage> {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            ElevatedButton.icon(
              onPressed: _openAddSpaceModal,
              icon: const Icon(Icons.add),
              label: const Text('Agregar Espacio', style: AppTheme.textSmall),
              style: ElevatedButton.styleFrom(
